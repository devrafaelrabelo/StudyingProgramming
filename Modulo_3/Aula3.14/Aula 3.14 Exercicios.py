...
print(lista_de_listas_de_inteiros[q])

for r in lista_de_listas_de_inteiros[q]:
    letra = r
    cont = 0
    print(f'letra para ser procurada {letra}')
    for x in lista_de_listas_de_inteiros[q]:
        if letra == x:
            cont += 1
        print(x)
    print(f'Letra repitiu {cont}x')
